...
<title>Cetak Surat Ahli Waris</title>
<style type="text/css">
body,td,th {
	font-size: 18px;
	font-family: Times;
...
<table border="0" align="center">
	...
	<tr>
		...
		<td align="justify" style="line-height: 22px;" width="350"><?php echo $tampil->alamat_ahli;?> RT <?php echo $tampil->rt_ahli;?> RW <?php echo $tampil->rw_ahli;?> Desa <?php echo $desa_ahli;?> Kecamatan <?php echo $tampil->kecamatan_ahli;?> Kabupaten <?php echo $tampil->kabupaten_ahli;?></td>
	</tr>
</table>	
<?php } } ?>
<br>
...
<table border="0" style="font-family: times; font-size: 18px;">
                            ...
                            <tr>
                                ...
                                <td align="center"><?php echo $atas_nama->status; ?></td>
                            </tr>
                            <tr>
                                <td width="10">&nbsp;</td>
                                <td align="center" width="200">&nbsp;</td>
                                <td style="width: 200;" align="center">&nbsp;</td>
                                <td align="center" width="200"><?php echo $atas_nama->jabatan; ?></td>
                            </tr>
                            <tr>
                                <td width="10">&nbsp;</td>
                                <td style="width: 200;">&nbsp;</td>
                            ...
                            <tr>
                                ...
                                <td align="center" width="200">&nbsp;</td>
                                <td style="width: 200;" align="center">&nbsp;</td>
                                <td align="center" width="200"><?php echo $atas_nama->nip; ?></td>
                            </tr>
                        </table>
</body>
</html>