...
<title>..::Rekap Data Kartu Keluarga::..</title>
<style type="text/css">
body,td,th {
	font-size: 10px;
}
...
<h4 style="text-align: center;">Rekap Data Kartu Keluarga, Update Tanggal <?php $tanggal_hari_ini= date('Y-m-d'); echo tgl_indo($tanggal_hari_ini); ?></h4><br><br>
<div id="tab1" class="tab_content">
<table width="300" class="table" align="center" cellpadding="0" cellspacing="0" border="1">
<thead align="center">
	<tr>
		<th max-width="50">No</th>
		<th max-width="250">Nama Kepala Keluarga</th>
		<th max-width="180">Nomor KTP</th>
		<th max-width="180">Nomor KK</th>
...
if ( ! empty($kartu_keluarga)) {
	...
	foreach($kartu_keluarga->result() as $tampil) {
		...
		echo "<td width=250>".$tampil->no_kk."</td>";
...
<tfoot>
	<tr bgcolor="#4e73df">
		...
		<td><div align="center"><b><?php echo $kartu_keluarga->num_rows();?></b></div></td>
	</tr>
</tfoot>
</table>
</div>
