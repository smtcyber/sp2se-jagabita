...
<table border="0" width="auto" align="left">
	...
	<tr>
		...
		<td align="left" width="400" style="line-height: 23px;"><?php echo $tampil->dusun;?> RT <?php echo $tampil->rt;?> RW <?php echo $tampil->rw;?> Desa <?php echo ucwords(strtolower($tampil->kelurahan)) ?> Kecamatan <?php echo ucwords(strtolower($tampil->kecamatan)) ?> Kabupaten <?php echo ucwords(strtolower($tampil->kabupaten)) ?></td>
	</tr>
</table>
<table border="0" width="auto" align="left">
	<tr>
