...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Tambah Pernyataan Gadai</li>
      </ol>
</section>
...
<form role="form" action="<?php echo site_url().'/c_gadai/proses_tambah_gadai'?>" method="post" enctype="multipart/form-data" autocomplete="on">
<div class="box-body">
...
<div class="form-group" >
    ...
    <input class="form-control" name="musim" id="musim" placeholder="Ketikkan Musim disini" required>
</div>
<div class="form-group" >
    <label><b>Lama Gadai :</b></label>
    <input class="form-control" name="lama" id="lama" placeholder="Ketikkan Lama Gadai disini" required>
</div>
<div class="form-group" >
