...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Edit Pernyataan Gadai</li>
      </ol>
</section>
...
<form role="form" action="<?php echo site_url().'/c_gadai/proses_edit_gadai'?>" method="post" enctype="multipart/form-data" autocomplete="on">
<?php foreach ($edit_gadai->result() as $tampil) { ?>
<div class="box-body">
<div class="form-group">
<input type="hidden" class="form-control" name="H1" id="H1" value="<?php echo $tampil->id_gadai; ?>" />
</div>
<div class="form-group" >
...
<div class="col-md-4">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Rincian Gadai</h3>
            </div>
<div class="box-body">
<div class="form-group" >
...
<div class="form-group" >
    <label><b>Musim :</b></label>
    <input class="form-control" name="musim" id="musim" value="<?php echo $tampil->musim; ?>" required>
</div>
<div class="form-group" >
    <label><b>Lama Gadai :</b></label>
    <input class="form-control" name="lama" id="lama" value="<?php echo $tampil->lama; ?>" required>
</div>
<div class="form-group" >
...
<div class="form-group" align="center">
    ...
    <a class="btn btn-danger" href="<?php echo site_url('c_gadai/gadai');?>"><i class='fa fa-times'></i> Batal</a>
</div>
<?php } ?>
</form>
</div>
