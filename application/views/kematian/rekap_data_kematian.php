...
<title>..::Rekap Data Pernyataan Kematian::..</title>
<style type="text/css">
body,td,th {
	font-size: 10px;
}
...
<h4 style="text-align: center;">Rekap Data Pernyataan Kematian, Update Tanggal <?php $tanggal_hari_ini= date('Y-m-d'); echo tgl_indo($tanggal_hari_ini); ?></h4><br><br>
<div id="tab1" class="tab_content">
<table width="300" class="table" align="center" cellpadding="0" cellspacing="0" border="1">
<thead align="center">
	<tr>
		<th max-width="50">No</th>
		<th max-width="250">Nama Orang Meninggal</th>
		<th max-width="180">Nik</th>
		<th max-width="200">Nama Pelapor</th>
...
if ( ! empty($kematian)) {
	...
	foreach($kematian->result() as $tampil) {
		...
		echo "<td width=200>".$tampil->nama_pelapor."</td>";
...
<tfoot>
	<tr bgcolor="#4e73df">
		...
		<td><div align="center"><b><?php echo $kematian->num_rows();?></b></div></td>
	</tr>
</tfoot>
</table>
</div>
