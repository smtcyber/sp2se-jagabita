...
<br>
<h3 style="text-align: center; font-family: Times;"><u><b>SURAT KETERANGAN PEMAKAMAN</b></u><br></h3>
...
<table border="0" align="center" style="line-height: 25px;">
	...
	<tr>
	    <td width="30">&nbsp;</td>
		<td width="30" align="center" valign="top">-</td>
		<td width="620" align="justify">Bahwa nama tersebut saat ini berdomisili pada alamat di atas dan nama tersebut telah meninggal dunia</td>
	    <td width="20">&nbsp;</td>
	</tr>
	<tr>
	    <td width="30">&nbsp;</td>
		<td width="30" align="center" valign="top">-</td>
		<td width="620" align="justify">Bahwa benar nama tersebut akan dimakamkan pada tanggal <?= tgl_indo(date('Y-m-d', strtotime($tampil->tanggal_meninggal))) ?> di <?= $tampil->tpu ?></td>
	    <td width="20">&nbsp;</td>
	</tr>
</table>
<table border="0" align="center" style="line-height: 25px;">
