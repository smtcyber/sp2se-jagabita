...
<title>..::Rekap Data Keterangan Lain-lain::..</title>
<style type="text/css">
body,td,th {
	font-size: 10px;
}
...
<h4 style="text-align: center;">Rekap Data Pernyataan Keterangan Lain-Lain, Update Tanggal <?php $tanggal_hari_ini= date('Y-m-d'); echo tgl_indo($tanggal_hari_ini); ?></h4><br><br>
...
<tfoot>
	<tr bgcolor="#4e73df">
		...
		<td><div align="center"><b><?php echo $lain_lain->num_rows();?></b></div></td>
	</tr>
</tfoot>
</table>
</div>
