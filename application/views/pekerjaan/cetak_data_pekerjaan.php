...
<table border="0" align="center" style="line-height: 25px;">
	<tr>
	    <td width="30">&nbsp;</td>
		<td width="620" align="justify">Menerangkan bahwa saat ini pekerjaan saya bukan lagi sebagai <b><?= $tampil->pekerjaan_lama ?></b> melainkan Sebagai <b><?= $tampil->pekerjaan_sekarang ?></b>. <br>Demikian surat pernyataan ini saya buat dalam keadaan sehat jasmani dan rohani, tanpa ada paksaan dari pihak manapun, dan dapat dipertanggungjawabkan.</td>
	    <td width="20">&nbsp;</td>
	</tr>
</table>
<br>
...
<table border="0" style="width: 100%; font-family: times; font-size: 18px;">
	...
	<td style="width: 5%"></td>
        <td align="left" style="width: 30%;">_______________</td>
        <td align="center" style="width: 15%;"></td>
        <td align="center" style="width: 45%;"><b><u><?php echo $tampil->nama; ?></u></b></td>
    </tr>
    <tr>
		<td style="width: 5%"></td>
...
<table border="0" style="width: 100%; font-family: times; font-size: 18px;">
	...
	<tr>
        <td style="width: 5%"></td>
        <td align="left" style="width: 20%;"></td>
        <td align="center" style="width: 45%;"><?= $kepdes->jabatan ?></td>
        <td align="center" style="width: 25%;"></td>
	</tr>
	<tr>
	...
	<tr>
        <td style="width: 5%"></td>
        <td align="left" style="width: 20%;"></td>
        <td align="center" style="width: 45%;"><?= $kepdes->nama_kades ?></td>
        <td align="center" style="width: 25%;"></td>
	</tr>
</table>
</body>
