...
<section class="content-header">
      <h1>
        Data Tabel
        <xsall>Keterangan Pekerjaan</xsall>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-table"></i> Data SP2SE</a></li>
        <li class="active">Keterangan Pekerjaan</li>
      </ol>
</section>
...
<!-- <a href="<?php echo site_url().'/c_pekerjaan/tambah_pekerjaan'?>" class="btn btn-primary btn-rounded">
              ...
              <div class="table-responsive">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <?php } else {
                      $no=1;
                      foreach ($pekerjaan->result() as $tampil) {
                    ?>
                    <tr>
                      ...
                      <td valign="left"><div align="left">
                          <a class="btn btn-warning btn-xs btn-rounded" href="<?php echo base_url()?>index.php/c_pekerjaan/edit_pekerjaan/<?php echo $tampil->id_pekerjaan ?>" title="Edit Beda Identitas"><i class="fa fa-edit"></i> Edit</a>
                          <a class="btn btn-danger btn-xs btn-rounded" href="<?php echo base_url()?>index.php/c_pekerjaan/proses_hapus_pekerjaan/<?php echo $tampil->id_pekerjaan ?>"
                          ...
                          <div class="btn-group">
                            ...
                            <ul class="dropdown-menu" role="menu">
                              <li><a style="color:black;" target="_blank" href="<?php echo base_url()?>index.php/c_pekerjaan/pekerjaan_cetak/<?php echo $tampil->id_pekerjaan ?>"><b>Print Kades</b></a></li>
                              <li><a style="color:black;" target="_blank" href="<?php echo base_url()?>index.php/c_pekerjaan/pekerjaan_cetak1/<?php echo $tampil->id_pekerjaan ?>"><b>Print Atas Nama</b></a></li>
                            </ul>
                          </div>
                      </td>
                    </tr>
