...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Tambah Ghoib</li>
      </ol>
</section>
...
<form role="form" action="<?php echo site_url().'/c_ghoib/proses_tambah_ghoib'?>" method="post" enctype="multipart/form-data" autocomplete="on">
<div class="box-body">
