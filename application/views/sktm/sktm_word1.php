...
<table border="0" align="justify">
	<tr>
		<td width="40">&nbsp;</td>
		<td width="630" align="justify" style="line-height: 25px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Nama tersebut diatas warga Desa <?php echo ucwords(strtolower($tampil->kelurahan)) ?> dan bertempat tinggal menetap di alamat tersebut diatas menurut pengakuan yang bersangkutan serta data yang ada pada kami keadaan ekonominya kurang Mampu/Miskin. Surat keterangan ini akan digunakan untuk <b><?php echo $tampil->keperluan_umum;?></b>.</td>
		<td width="20">&nbsp;</td>
	</tr>
</table><br>
<table border="0" align="justify">
