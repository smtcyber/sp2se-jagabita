...
<div class="form-group" >
    <label><b>NIK :</b></label>
    <input class="form-control" name="P1" id="P1" placeholder="Masukkan Nomor NIK disini" required>
</div>
<div class="form-group" >
    <label><b>Nomor KK :</b></label>
    <td width="500"><input class="form-control" name="P2" id="P2" placeholder="Ketikan Nomor KK disini" required />
</div>
<div class="form-group" >
    <label><b>Nama :</b></label>
    <input class="form-control" name="P3" id="P3" placeholder="Ketikkan Nama Lengkap disini" required />
</div>
<div class="form-group" >
...
<div class="form-group" >
    ...
    <input class="form-control" name="P6" id="P6" placeholder="Ketikkan tempat lahir disini" required />
</div>
<div class="form-group" >
    <label><b>Tanggal Lahir :</b></label>
    <input class="form-control" name="P7" id="tgl1" placeholder="Masukkan tanggal lahir disini" required />
</div>
<div class="form-group" >
...
<div class="form-group" >
    ...
    <input class="form-control" name="P9" id="P9" placeholder="Ketikkan RT disini" required />
    <input class="form-control" name="P10" id="P10" placeholder="Ketikkan RW disini" required />
</div>
<div class="form-group" >
    <label><b>Alamat :</b></label>
    <input class="form-control" name="P11" id="P11" placeholder="Masukkan Alamat disini" required>
</div>
<div class="form-group" >
    <label><b>Desa, Kecamatan dan Kabupaten :</b></label>
    <input class="form-control" name="P12" id="P12" placeholder="Ketikkan Desa disini" required />
    <input class="form-control" name="P13" id="P13" placeholder="Ketikkan Kecamatan disini" required />
    <input class="form-control" name="P14" id="P14" placeholder="Ketikkan Kabupaten disini" required>
