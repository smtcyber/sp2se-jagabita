...
<title>..::Rekap Data Domisili Usaha::..</title>
<style type="text/css">
body,td,th {
	font-size: 10px;
}
...
<h4 style="text-align: center;">Rekap Data Domisili Usaha, Update Tanggal <?php $tanggal_hari_ini= date('Y-m-d'); echo tgl_indo($tanggal_hari_ini); ?></h4><br><br>
...
<thead align="center">
	<tr>
		...
		<th max-width="200">Nama Perusahaan</th>
		<th width="180">Tanggal Surat</th>
	</tr>
</thead>
<tbody align="center">
<?php
if ( ! empty($domisili_usaha)) {
	$no = 1;
	foreach($domisili_usaha->result() as $tampil) {
		...
		echo "<td width=200>".$tampil->nama_perusahaan."</td>";
...
<tfoot>
	<tr bgcolor="#4e73df">
		...
		<td><div align="center"><b><?php echo $domisili_usaha->num_rows();?></b></div></td>
	</tr>
</tfoot>
</table>
</div>
