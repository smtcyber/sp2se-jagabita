...
<table border="0" align="center">
	...
	<tr>
		...
		<td align="left" width="20">:</td>
		<td align="left" width="350"><?php echo $tampil->jabatan;?></td>
	</tr>
	<tr>
		<td width="30">&nbsp;</td>
...
<table border="0" align="center" style="line-height: 25px;">
	<tr>
	    <td width="30">&nbsp;</td>
		<td width="620" align="justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Adalah benar bahwa Perusahaan "<?php echo $tampil->jenis_usaha;?>" pada saat ini berdomisili di desa <?php echo ucwords(strtolower($tampil->kelurahan)) ?> RT <?php echo $tampil->rt;?> RW <?php echo $tampil->rw;?>Kecamatan <?php echo ucwords(strtolower($tampil->kecamatan)) ?> Kabupaten <?php echo ucwords(strtolower($tampil->kabupaten)) ?>.</td>
	    <td width="20">&nbsp;</td>
	</tr>
</table>
<br>
