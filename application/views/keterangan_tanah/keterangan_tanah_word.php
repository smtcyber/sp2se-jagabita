...
<head>
    ...
    $nama_file = "keterangan_tanah.doc";
...
<table align="center" border="1" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<td align="center" width="270"><?php echo $tampil->no_objek_pajak;?></td>
		<td align="center" width="270"><?php echo $tampil->nama;?></td>
	</tr>
</table><br>
<table border="0" align="center" style="line-height: 25px; ">
	<tr>
		<td width="40">&nbsp;</td>
		<td width="620" align="justify">Dasar Tanah Darat tersebut milik <?php echo $tampil->nama;?></td>
		<td width="40">&nbsp;</td>
	</tr>
</table>
<br>
