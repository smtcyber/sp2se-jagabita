...
<title>..::Rekap Data Domisili Sekolah::..</title>
<style type="text/css">
body,td,th {
	font-size: 10px;
}
...
<h4 style="text-align: center;">Rekap Data Domisili Sekolah, Update Tanggal <?php $tanggal_hari_ini= date('Y-m-d'); echo tgl_indo($tanggal_hari_ini); ?></h4><br><br>
<div id="tab1" class="tab_content">
<table width="300" class="table" align="center" cellpadding="0" cellspacing="0" border="1">
<thead align="center">
	<tr>
		<th max-width="50">No</th>
		<th max-width="300">Nama Sekolah</th>
...
if ( ! empty($domsekolah)) {
	...
	foreach($domsekolah->result() as $tampil) {
		...
		echo "<td width=300>".$tampil->nama_sekolah."</td>";
...
<tfoot>
	<tr bgcolor="#4e73df">
		...
		<td><div align="center"><b><?php echo $domsekolah->num_rows();?></b></div></td>
	</tr>
</tfoot>
</table>
</div>
