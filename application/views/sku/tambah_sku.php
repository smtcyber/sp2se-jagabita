...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Tambah Keterangan Usaha</li>
      </ol>
</section>
...
<form role="form" action="<?php echo site_url().'/c_sku/proses_tambah_sku'?>" method="post" enctype="multipart/form-data" autocomplete="on">
...
<div class="form-group" >
    ...
    <input class="form-control" name="bangsa" id="bangsa" placeholder="Ketikkan Bangsa disini" required>
</div>
<div class="form-group" >
...
<div class="form-group" >
    ...
    <input class="form-control" name="jenis_usaha" id="jenis_usaha" placeholder="Ketikkan Jenis Usaha disini" required>
</div>
<div class="form-group" >
    <label><b>Berpengalaman Selama :</b></label>
    <input class="form-control" name="selama" id="selama" placeholder="Ketikkan Selama disini">
</div>
<div class="form-group" >
