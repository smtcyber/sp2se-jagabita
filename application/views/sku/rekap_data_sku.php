...
<title>..::Rekap Data Keterangan Usaha::..</title>
<style type="text/css">
body,td,th {
	font-size: 10px;
}
...
<h4 style="text-align: center;">Rekap Data Pernyataan Keterangan Tidak Mampu, Update Tanggal <?php $tanggal_hari_ini= date('Y-m-d'); echo tgl_indo($tanggal_hari_ini); ?></h4><br><br>
...
<thead align="center">
	<tr>
		...
		<th max-width="200">Nomor KTP</th>
		<th max-width="200">Bidang Usaha</th>
...
if ( ! empty($sku)) {
	...
	foreach($sku->result() as $tampil) {
		...
		echo "<td width=200>".$tampil->jenis_usaha."</td>";
...
<tfoot>
	<tr bgcolor="#4e73df">
		...
		<td><div align="center"><b><?php echo $sku->num_rows();?></b></div></td>
	</tr>
</tfoot>
</table>
</div>
