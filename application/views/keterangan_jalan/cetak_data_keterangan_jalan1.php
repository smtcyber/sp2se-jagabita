...
<table border="0" align="center">
	<tr>
		...
		<td align="left" width="20">:</td>
		<td align="left" width="350"><?php echo $tampil->pergi_ke_jalan;?></td>
	</tr>
	<tr>
		<td width="30">&nbsp;</td>
		<td align="left" width="200">Tujuan</td>
		<td align="left" width="20">:</td>
		<td align="left" width="350"><?php echo $tampil->tujuan_jalan;?></td>
	</tr>
	<tr>
		<td width="30">&nbsp;</td>
		<td align="left" width="200">Waktu Lama</td>
		<td align="left" width="20">:</td>
		<td align="left" width="350"><?php echo $tampil->lama_jalan;?></td>
	</tr>
	<tr>
		<td width="30">&nbsp;</td>
		<td align="left" width="200">Keterangan</td>
		<td align="left" width="20">:</td>
		<td align="left" width="350"><?php echo $tampil->ket_jalan;?></td>
	</tr>
</table>
<br>
<table border="0" align="center" style="line-height: 25px;">
	<tr>
	    <td width="30">&nbsp;</td>
		<td width="620" align="justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Demikian surat Keterangan Perjalanan ini kami buat dengan sebenarnya  agar menjadi tahu dan maklum adanya.</td>
	    <td width="20">&nbsp;</td>
	</tr>
</table>
<br><br>
