...
<section class="content-header">
      <h1>
        Data Tabel
        <xsall>Belum Bekerja</xsall>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-table"></i> Data SP2SE</a></li>
        <li class="active">Belum Bekerja</li>
      </ol>
</section>
...
<!-- <a href="<?php echo site_url().'/c_belum_bekerja/tambah_belum_bekerja'?>" class="btn btn-primary btn-rounded">
                  ...
                  <tr>
                    ...
                    <tr>
                      ...
                      <td valign="left"><div align="left">
                          <a class="btn btn-warning btn-xs btn-rounded" href="<?php echo base_url()?>index.php/c_belum_bekerja/edit_belum_bekerja/<?php echo $tampil->id_belum_bekerja ?>" title="Edit Beda Identitas"><i class="fa fa-edit"></i> Edit</a>
                          <a class="btn btn-danger btn-xs btn-rounded" href="<?php echo base_url()?>index.php/c_belum_bekerja/proses_hapus_belum_bekerja/<?php echo $tampil->id_belum_bekerja ?>"
                          ...
                          <div class="btn-group">
                            ...
                            <ul class="dropdown-menu" role="menu">
                              <li><a style="color:black;" target="_blank" href="<?php echo base_url()?>index.php/c_belum_bekerja/belum_bekerja_cetak/<?php echo $tampil->id_belum_bekerja ?>"><b>Print Kades</b></a></li>
                              <li><a style="color:black;" target="_blank" href="<?php echo base_url()?>index.php/c_belum_bekerja/belum_bekerja_cetak1/<?php echo $tampil->id_belum_bekerja ?>"><b>Print Atas Nama</b></a></li>
                            </ul>
                          </div>
                      </td>
                    </tr>
