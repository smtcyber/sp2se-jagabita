...
<table border="0" align="center" style="line-height: 25px;">
	<tr>
	    <td width="30">&nbsp;</td>
		<td width="620" align="center"><b>------------------------------------- BELUM BEKERJA -------------------------------------</b></td>
	    <td width="20">&nbsp;</td>
	</tr>
</table>
<br>
<table border="0" align="center" style="line-height: 25px;">
	...
	<tr>
	    <td width="30">&nbsp;</td>
		<td width="620" align="justify">Bahwa nama tersebut benar warga kami dan bertempat tingga pada alamat diatas, dan menurut keterangan yang bersangkutan bahwa nama yang bersangkutan saat ini<b> belum/tidak bekerja</b>.</td>
	    <td width="20">&nbsp;</td>
	</tr>
</table>
<br>
<table>
	<tr>
		...
		<td width="590" align="justify">Surat keterangan ini kami berikan untuk <?= $tampil->keperluan ?></td>
	    <td width="20">&nbsp;</td>
	</tr>
</table>
<br>
