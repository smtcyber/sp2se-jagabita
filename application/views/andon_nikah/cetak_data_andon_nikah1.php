...
<title>Cetak Surat Andon Nikah</title>
<style type="text/css">
body,td,th {
	font-size: 18px;
	font-family: Times;
...
<br>
<h3 style="text-align: center; font-family: Times;"><u><b>SURAT KETERANGAN ANDON NIKAH</b></u><br></h3>
<?php $this->load->view('nomor_surat/no_andon_nikah') ?>
<br>
...
<table border="0" align="center">
	<tr>
		<td width="30">&nbsp;</td>
		<td align="left" width="200">NIK No. KTP</td>
	...
	<tr>
		<td width="30">&nbsp;</td>
		<td align="left" width="200">Golongan Darah</td>
		<td align="left" width="20">:</td>
		<td align="left" width="350"><?php echo $tampil->gol_darah;?></td>
	</tr>
	<tr>
		<td width="30">&nbsp;</td>
	...
	<tr>
		<td width="30">&nbsp;</td>
		<td align="left" width="200">Kelainan Fisik</td>
		<td align="left" width="20">:</td>
		<td align="left" width="350"><?php echo $tampil->kelainan_fisik;?></td>
	</tr>
	<tr>
		<td width="30">&nbsp;</td>
...
<table border="0" align="center" style="line-height: 25px;">
	<tr>
	    <td width="30">&nbsp;</td>
		<td width="620" align="justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Nama tersebut diatas adalah benar Warga Desa <?php echo ucwords(strtolower($tampil->kelurahan)) ?> Kecamatan <?php echo ucwords(strtolower($tampil->kecamatan)) ?> Kabupaten <?php echo ucwords(strtolower($tampil->kabupaten)) ?> yang akan menumpang nikah di <?php echo $tampil->tempat_nikah;?> pada  tanggal  <?php echo tgl_indo(date('Y-m-d', strtotime($tampil->tgl_nikah))); ?> hari <?php echo $tampil->hari_nikah;?> pukul <?php echo $tampil->waktu_nikah_mulai;?> s/d <?php echo $tampil->waktu_nikah_selesai;?> dengan :</td>
	    <td width="20">&nbsp;</td>
	</tr>
</table>
<br>
<table border="0" align="center">
	...
	<tr>
		<td width="30">&nbsp;</td>
		<td align="left" width="200">Nama Wali</td>
		<td align="left" width="20">:</td>
		<td align="left" width="350"><?php echo $tampil->nama_wali;?></td>
	</tr>
	<tr>
		<td width="30">&nbsp;</td>
		<td align="left" width="200">Hubungan Wali</td>
		<td align="left" width="20">:</td>
		<td align="left" width="350"><?php echo $tampil->status_wali;?></td>
	</tr>
</table>
<br>
<table border="0" align="center" style="line-height: 25px;">
