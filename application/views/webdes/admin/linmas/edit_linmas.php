...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Edit Linmas</li>
      </ol>
</section>
...
<form role="form" action="<?php echo site_url().'/webdes/proses_edit_linmas'?>" method="post" enctype="multipart/form-data" autocomplete="on">
<?php foreach ($edit_linmas->result() as $tampil) { ?>
<input class="form-control" type="hidden" name="H1" id="H1" value="<?php echo $tampil->id_linmas; ?>"/>
...
<div class="form-group" align="center">
    ...
    <a class="btn btn-danger" href="<?php echo site_url('webdes/linmas');?>"><i class='fa fa-times'></i> Batal</a><hr>
</div>
<?php } ?>
</form>
</div></div></div></div></div>