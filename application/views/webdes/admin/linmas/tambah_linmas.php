...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Tambah Linmas</li>
      </ol>
</section>
...
<form role="form" action="<?php echo site_url().'/webdes/proses_tambah_linmas'?>" method="post" autocomplete="on" />
<div class="form-group" >
    <label><b>Nama :</b></label>
    <input class="form-control" name="nama" id="nama" placeholder="Ketikkan Nama disini">
</div>
<div class="form-group" >
