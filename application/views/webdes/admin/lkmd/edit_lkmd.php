...
<form role="form" action="<?php echo site_url().'/webdes/proses_edit_lkmd'?>" method="post" enctype="multipart/form-data" autocomplete="on">
<?php foreach ($edit_lkmd->result() as $tampil) { ?>
<input class="form-control" type="hidden" name="H1" id="H1" value="<?php echo $tampil->id_lkmd; ?>"/>
...
<div class="form-group" align="center">
    ...
    <a class="btn btn-danger" href="<?php echo site_url('webdes/lkmd');?>"><i class='fa fa-times'></i> Batal</a><hr>
</div>
<?php } ?>
</form>
</div></div></div></div></div>