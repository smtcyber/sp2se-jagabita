...
<a href="<?php echo site_url().'/webdes/tambah_pkk'?>" class="btn btn-primary btn-rounded">
                  ...
                  <tr>
                    ...
                    <tr>
                      ...
                      <td valign="left"><div align="left">
                          <a class="btn btn-warning btn-xs btn-rounded" href="<?php echo base_url()?>index.php/webdes/edit_pkk/<?php echo $tampil->id_pkk ?>" title="Edit Data"><i class="fa fa-edit"></i> Edit PKK</a>
                          <a class="btn btn-danger btn-xs btn-rounded" href="<?php echo base_url()?>index.php/webdes/proses_hapus_pkk/<?php echo $tampil->id_pkk ?>"
