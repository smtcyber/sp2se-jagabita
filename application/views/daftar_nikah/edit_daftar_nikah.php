...
<div class="form-group" >
    <label><b>Nama Mantan Calon :</b></label>
    <input class="form-control" name="nama_mantan_calon" id="nama_mantan_calon" value="<?php echo $tampil->nama_mantan_calon; ?>" >
...
<div class="form-group" >
    <label><b>Bin :</b></label>
    <input class="form-control" name="bin_ayah" id="bin_ayah" value="<?php echo $tampil->bin_ayah; ?>" required>
</div>
<div class="form-group" >
...
<div class="form-group" >
    <label><b>Bin :</b></label>
    <input class="form-control" name="bin_ibu" id="bin_ibu" value="<?php echo $tampil->bin_ibu; ?>" required>
</div>
<div class="form-group" >
...
<div class="form-group" >
    <label><b>Bin :</b></label>
    <input class="form-control" name="bin_calon" id="bin_calon" value="<?php echo $tampil->bin_calon; ?>" required>
</div>
<div class="form-group" >
