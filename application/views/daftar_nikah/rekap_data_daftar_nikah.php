...
<title>..::Rekap Data Daftar Nikah::..</title>
<style type="text/css">
body,td,th {
	font-size: 10px;
}
...
<h4 style="text-align: center;">Rekap Data Daftar Nikah, Update Tanggal <?php $tanggal_hari_ini= date('Y-m-d'); echo tgl_indo($tanggal_hari_ini); ?></h4><br><br>
...
<thead align="center">
	<tr>
		...
		<th max-width="200">Nama Calon</th>
		<th width="180">Tanggal Surat</th>
	</tr>
</thead>
<tbody align="center">
<?php
if ( ! empty($daftar_nikah)) {
	$no = 1;
	foreach($daftar_nikah->result() as $tampil) {
		...
		echo "<td width=200>".$tampil->nama_calon."</td>";
...
<tfoot>
	<tr bgcolor="#4e73df">
		...
		<td><div align="center"><b><?php echo $daftar_nikah->num_rows();?></b></div></td>
	</tr>
</tfoot>
</table>
</div>
