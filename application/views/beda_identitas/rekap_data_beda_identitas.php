...
<title>..::Rekap Data Beda Identitas::..</title>
<style type="text/css">
body,td,th {
	font-size: 10px;
}
...
<h4 style="text-align: center;">Rekap Data Beda Identitas, Update Tanggal <?php $tanggal_hari_ini= date('Y-m-d'); echo tgl_indo($tanggal_hari_ini); ?></h4><br><br>
...
if ( ! empty($beda_identitas)) {
	...
	foreach($beda_identitas->result() as $tampil) {
		...
		echo "<td width=180>".$tampil->no_kk."</td>";
...
<tfoot>
	<tr bgcolor="#4e73df">
		...
		<td><div align="center"><b><?php echo $beda_identitas->num_rows();?></b></div></td>
	</tr>
</tfoot>
</table>
</div>
