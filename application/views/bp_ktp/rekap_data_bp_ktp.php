...
<title>..::Rekap Data Belum Punya KTP::..</title>
<style type="text/css">
body,td,th {
	font-size: 10px;
}
...
<h4 style="text-align: center;">Rekap Data Belum Punya KTP, Update Tanggal <?php $tanggal_hari_ini= date('Y-m-d'); echo tgl_indo($tanggal_hari_ini); ?></h4><br><br>
...
<thead align="center">
	<tr>
		...
		<th max-width="200">Untuk Persyaratan</th>
...
if ( ! empty($bp_ktp)) {
	...
	foreach($bp_ktp->result() as $tampil) {
		...
		echo "<td width=200>".$tampil->untuk_persyaratan."</td>";
...
<tfoot>
	<tr bgcolor="#4e73df">
		...
		<td><div align="center"><b><?php echo $bp_ktp->num_rows();?></b></div></td>
	</tr>
</tfoot>
</table>
</div>
