<table border="0" style="width: 100%; font-size: 13px;">
    ...
    <tr>
        ...
        <td align="center" style="width: 30%;"></td>
        <td align="center" style="width: 33%; font-size: 13px; text-transform: uppercase;"><b><?php echo $kepdes->jabatan; ?> <?php echo ucwords(strtolower($tampil->kelurahan)) ?></b></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td align="center" style="width: 30%;"></td>
        <td align="center" style="width: 33%; font-size: 13px;"><b><u><?php echo $kepdes->nama_kades; ?></u></b></td>
    </tr>
    <tr>
