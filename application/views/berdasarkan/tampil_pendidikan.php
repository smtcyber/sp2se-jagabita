...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Penduduk Berdasarkan Pendidikan</li>
      </ol>
</section>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Penduduk Berdasarkan Pendidikan</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
<?php
...
<?php } ?>
<a href="<?php echo site_url().'/dashboard/berdasarkan'?>" class="btn btn-danger btn-rounded">
<i class="fa fa-undo fa-white"></i> &nbsp;Kembali</a>
<a class="btn btn-success" onclick="printContent('div1')">Print Data</a>
    <div class="box-body">
      <h3>Pendidikan Penduduk <?php echo $header->desa; ?></h3>
        <div id="div1">
            <table class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <tr>
                      ...
                      <td valign="left"><?php echo $tampil->pendidikan; ?></td>
                    </tr>
                    <?php } } ?>
                  </tbody>
                </table>
