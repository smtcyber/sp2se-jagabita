...
<table>
	...
	<tr>
		<td width="220" align="center">&nbsp;</td>
		<td width="220" align="center"></td>
		<td width="220" align="center"><?php echo $tampil->nama ?></td>
	</tr>
	<tr>
		<td width="220" align="center">&nbsp;</td>
	...
	<tr>
		<td width="220" align="center">Ketua RW <?php echo $tampil->rw ?></td>
		<td width="220" align="center"></td>
		<td width="220" align="center">Ketua RT <?php echo $tampil->rt ?></td>
	</tr>
	<tr>
		<td width="220" align="center">&nbsp;</td>
		<td width="220" align="center"></td>
...
<table>
	<tr>
		...
		<td width="420" align="center"><?php echo $atas_nama->status ?></td>
		<td width="120" align="center"></td>
	</tr>
	<tr>
		<td width="120" align="center">&nbsp;</td>
		<td width="420" align="center"><?php echo $atas_nama->jabatan ?></td>
		<td width="120" align="center"></td>
	</tr>
	<tr>
		<td width="120" align="center">&nbsp;</td>
	...
	<tr>
		<td width="120" align="center">&nbsp;</td>
		<td width="420" align="center"><?php echo $atas_nama->atas_nama ?></td>
		<td width="120" align="center"></td>
	</tr>
</table>
</body>
