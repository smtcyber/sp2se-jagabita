...
<br>
<h3 style="text-align: center; font-family: Times;"><u><b>SURAT KETERANGAN BELUM PERNAH MENIKAH</b></u><br></h3>
<?php $this->load->view('nomor_surat/no_skbn') ?>
<br>
...
<table border="0" align="center">
	...
	<tr>
		<td width="30">&nbsp;</td>
		<td align="left" width="200">Warga Negara / Agama</td>
		<td align="left" width="20">:</td>
	...
	<tr>
		<td width="30">&nbsp;</td>
		<td align="left" width="200">Dengan ini menerangkan</td>
		<td align="left" width="20">:</td>
		<td align="left" width="350"></td>
	</tr>
</table>
<table border="0" align="center" style="line-height: 25px;">
	<tr>
	    <td width="68">&nbsp;</td>
		<td width="600" align="justify">Bahwa nama tersebut diatas benar warga kami dan bertempat tinggal pada alamat diatas, dan sepengetahuan kami hingga saat ini nama tersebut diatas <b>BELUM PERNAH MENIKAH / KAWIN.</b></td>
	    <td width="20">&nbsp;</td>
	</tr>
</table>
<br>
...
<tr>
		<td width="68">&nbsp;</td>
		<td align="left" width="280">Surat Keterangan ini dibuat untuk</td>
		<td align="left" width="20">:</td>
		<td align="left" width="350"><b><?php echo $tampil->keperluan ?></b></td>
	</tr>
</table>
<br>
<br>
<table border="0" align="center" style="line-height: 25px;">
	<tr>
	    <td width="68">&nbsp;</td>
		<td width="600" align="justify">Demikian surat keterangan ini dibuat dengan sebenarnya, untuk dipergunakan sebagaimana mestinya.</td>
	    <td width="20">&nbsp;</td>
	</tr>
</table>
<br>
