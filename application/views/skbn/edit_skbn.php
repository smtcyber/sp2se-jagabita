...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Edit Belum Menikah/Janda/Duda</li>
      </ol>
</section>
...
<form role="form" action="<?php echo site_url().'/c_skbn/proses_edit_skbn'?>" method="post" enctype="multipart/form-data" autocomplete="on">
<?php foreach ($edit_skbn->result() as $tampil) { ?>
<div class="box-body">
<div class="form-group">
<input type="hidden" class="form-control" name="H1" id="H1" value="<?php echo $tampil->id_belum_nikah; ?>" />
