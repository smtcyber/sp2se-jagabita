...
<br>
<h3 style="text-align: center; font-family: Times;"><u><b>SURAT KETERANGAN BELUM PERNAH NIKAH</b></u><br></h3>
...
<table border="0" align="center" style="line-height: 25px;">
	<tr>
	    <td width="30">&nbsp;</td>
		<td width="620" align="justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Adalah benar penduduk Desa <?php echo ucwords(strtolower($tampil->kelurahan)) ?> Kecamatan <?php echo ucwords(strtolower($tampil->kecamatan)) ?> Kabupaten <?php echo ucwords(strtolower($tampil->kabupaten)) ?> berdomisili di RT <?php echo $tampil->rt;?> RW <?php echo $tampil->rw;?> dan yang bersangkutan <b>Belum Pernah Menikah</b> sampai dengan saat ini.</td>
	    <td width="20">&nbsp;</td>
	</tr>
</table>
<br>
