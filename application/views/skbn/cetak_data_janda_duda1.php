...
<table border="0" align="center" style="line-height: 25px;">
	...
	<tr>
	    <td width="30">&nbsp;</td>
		<td width="620" align="justify">Bahwa nama tersebut diatas benar warga kami dan bertempat tinggal pada alamat diatas dan sejak isteri nya yang bernama <?php echo $tampil->nama_alm_istri ?> meninggal dunia pada tanggal <?php echo $tampil->tanggal_meninggal ?> sampai saat ini yang bersangkutan belum menikah lagi/<?php echo $status ?>.</td>
	    <td width="20">&nbsp;</td>
	</tr>
</table>
<br>
