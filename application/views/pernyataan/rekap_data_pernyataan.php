...
<title>..::Rekap Data Pernyataan::..</title>
<style type="text/css">
body,td,th {
	font-size: 10px;
}
...
<h4 style="text-align: center;">Rekap Data Pernyataan, Update Tanggal <?php $tanggal_hari_ini= date('Y-m-d'); echo tgl_indo($tanggal_hari_ini); ?></h4><br><br>
...
if ( ! empty($pernyataan)) {
	...
	foreach($pernyataan->result() as $tampil) {
		...
		echo "<td width=200>".$tampil->keperluan."</td>";
...
<tfoot>
	<tr bgcolor="#4e73df">
		...
		<td><div align="center"><b><?php echo $pernyataan->num_rows();?></b></div></td>
	</tr>
</tfoot>
</table>
</div>
