...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Edit Surat Pernyataaan Umum</li>
      </ol>
</section>
...
<form role="form" action="<?php echo site_url().'/c_pernyataan/proses_edit_pernyataan'?>" method="post" enctype="multipart/form-data" autocomplete="on">
<?php foreach ($edit_pernyataan->result() as $tampil) { ?>
<div class="form-group">
<input type="hidden" class="form-control" name="H1" id="H1" value="<?php echo $tampil->id_surat_pernyataan; ?>" />
<br>
<div class="form-group" >
...
<div class="form-group" align="center">
    ...
    <a class="btn btn-danger" href="<?php echo site_url('c_pernyataan/pernyataan');?>"><i class='fa fa-times'></i> Batal</a>
</div>
<?php } ?>
</form>
</div></div></div></div></div>