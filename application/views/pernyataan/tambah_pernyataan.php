...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Tambah Surat Pernyataaan</li>
      </ol>
</section>
...
<form role="form" action="<?php echo site_url().'/c_pernyataan/proses_tambah_pernyataan'?>" method="post" enctype="multipart/form-data" autocomplete="on">
...
<div class="form-group" align="center">
    ...
    <a class="btn btn-danger" href="<?php echo site_url('c_pernyataan/pernyataan');?>"><i class='fa fa-times'></i> Batal</a><hr>
</div>
</form>
</div></div></div></div></div>