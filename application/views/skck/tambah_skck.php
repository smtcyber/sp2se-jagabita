...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Tambah SKCK</li>
      </ol>
</section>
...
<form role="form" action="<?php echo site_url().'/c_skck/proses_tambah_skck'?>" method="post" enctype="multipart/form-data" autocomplete="on">
