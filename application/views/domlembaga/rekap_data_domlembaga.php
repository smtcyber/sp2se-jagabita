...
<title>..::Rekap Data Domisili Lembaga::..</title>
<style type="text/css">
body,td,th {
	font-size: 10px;
}
...
<h4 style="text-align: center;">Rekap Data Domisili Lembaga, Update Tanggal <?php $tanggal_hari_ini= date('Y-m-d'); echo tgl_indo($tanggal_hari_ini); ?></h4><br><br>
<div id="tab1" class="tab_content">
<table width="300" class="table" align="center" cellpadding="0" cellspacing="0" border="1">
<thead align="center">
	<tr>
		<th max-width="50">No</th>
		<th max-width="300">Nama Lembaga</th>
...
if ( ! empty($domlembaga)) {
	...
	foreach($domlembaga->result() as $tampil) {
		...
		echo "<td width=300>".$tampil->nama_lembaga."</td>";
...
<tfoot>
	<tr bgcolor="#4e73df">
		...
		<td><div align="center"><b><?php echo $domlembaga->num_rows();?></b></div></td>
	</tr>
</tfoot>
</table>
</div>
