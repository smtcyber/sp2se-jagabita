...
<title>..::Rekap Data Pernyataan Kehilangan::..</title>
<style type="text/css">
body,td,th {
	font-size: 10px;
}
...
<h4 style="text-align: center;">Rekap Data Pernyataan Kehilangan, Update Tanggal <?php $tanggal_hari_ini= date('Y-m-d'); echo tgl_indo($tanggal_hari_ini); ?></h4><br><br>
...
<thead align="center">
	<tr>
		...
		<th max-width="200">kehilangan</th>
...
if ( ! empty($kehilangan)) {
	...
	foreach($kehilangan->result() as $tampil) {
		...
		echo "<td width=200>".$tampil->kehilangan."</td>";
...
<tfoot>
	<tr bgcolor="#4e73df">
		...
		<td><div align="center"><b><?php echo $kehilangan->num_rows();?></b></div></td>
	</tr>
</tfoot>
</table>
</div>
