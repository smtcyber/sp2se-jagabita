...
<br>
<h3 style="text-align: center; font-family: Times;"><u><b>SURAT KEHILANGAN</b></u><br></h3>
...
<table border="0" align="center" style="line-height: 25px;">
	<tr>
	    <td width="30">&nbsp;</td>
		<td width="620" align="justify">Menerangkan bahwa benar-benar telah kehilangan <?php echo $tampil->kehilangan;?></td>
	    <td width="20">&nbsp;</td>
	</tr>
</table>
<br>
