                ...
                <div class="tm-flex">
                    <div class="tm-bg-white-translucent text-xs-left tm-textbox tm-textbox-padding" style="background-color: #E6E6FA;">
                        <h2 class="tm-text-title" align="center">SURAT KETERANGAN USAHA</h2>
                            <div class="container">
                                <form action="<?php echo site_url().'/c_sku/proses_panel_sku'?>" method="post">
                                    <div class="row">
                                        <div class="col-69">
                                    ...
                                    <div class="row">
                                        <div class="col-75">
                                            <input class="use-keyboard-input" type="text" id="nama_usaha" name="nama_usaha" placeholder="Masukkan Nama Usaha Anda">
                                        </div>
                                    </div>
                                    <br>
                                    <div class="row">
                                        <div class="col-75">
                                            <input class="use-keyboard-input" type="text" id="penghasilan" name="penghasilan" placeholder="Masukkan Jumlah Penghasilan Perbulan">
                                        </div>
                                    </div>
                                    <br>
                                    <div class="row">
                                        <div class="col-75">
                                            <input class="use-keyboard-input" type="text" id="lokasi_usaha" name="lokasi_usaha" placeholder="Masukkan Alamat/Lokasi Usaha Anda">
                                        </div>
                                    </div>
                                    <br><br>
