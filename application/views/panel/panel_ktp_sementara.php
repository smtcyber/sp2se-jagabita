                ...
                <div class="tm-flex">
                    <div class="tm-bg-white-translucent text-xs-left tm-textbox tm-textbox-padding" style="background-color: #E6E6FA;">
                        <h2 class="tm-text-title" align="center">SURAT KETERANGAN KTP SEMENTARA</h2>
                            <div class="container">
                                <form action="<?php echo site_url().'/c_ktp_sementara/proses_panel_ktp_sementara'?>" method="post">
                                    <div class="row">
                                        <div class="col-69">
                                    ...
                                    <!-- <div class="row">
                                        <div class="col-75">
                                            <input class="use-keyboard-input" type="text" id="lname" name="keperluan" placeholder="Masukkan Keperluan Anda">
                                        </div>
                                    </div> -->
                                    <br><br>
