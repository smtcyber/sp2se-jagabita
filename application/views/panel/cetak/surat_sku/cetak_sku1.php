...
<table border="0" align="left" style="font-size: 17px; font-family: times;">
	<tr>
		...
		<td align="justify"><b><?php echo $data->nama;?></b></td>
	</tr>
	<tr>
		<td>&nbsp;</td>
		<td align="left">Jenis Kelamin</td>
		<td align="left">:</td>
		<td align="justify"><?php echo ucwords(strtolower($data->kelamin)) ?></td>
	</tr>
	<tr>
		<td>&nbsp;</td>
	...
	<tr>
		...
		<td align="left">:</td>
		<td align="justify"><?php echo ucwords(strtolower($data->agama)) ?></td>
	</tr>
	<tr>
		<td>&nbsp;</td>
		<td align="left">Pekerjaan</td>
		<td align="left">:</td>
		<td align="justify"><?php echo ucwords(strtolower($data->pekerjaan)) ?></td>
	</tr>
	<tr>
		<td>&nbsp;</td>
		<td align="left" valign="top">Alamat</td>
		<td align="left" valign="top">:</td>
		<td align="justify" width="350"><?php echo ucwords(strtolower($data->dusun)) ?> Rt.<?php echo $data->rt;?>/<?php echo $data->rw;?> Desa <?php echo ucwords(strtolower($data->kelurahan)) ?></td>
	</tr>
</table>
...
<table border="0" align="justify" style="line-height: 25px; font-family: times; font-size: 18px;">
	<tr>
		...
		<td width="10">:</td>
		<td width="400"><?php echo $data->lokasi_usaha ?></td>
	</tr>
	<tr>
		<td width="70" align="right" valign="top"> &nbsp; &nbsp; &nbsp;</td>
		<td width="200" align="left">Jenis Usaha</td>
		<td width="10">:</td>
		<td width="400"> <b><?php echo $data->nama_usaha ?></b></td>
	</tr>
	<tr>
		<td width="70" align="right" valign="top"> &nbsp; &nbsp; &nbsp;</td>
		<td width="200" align="left">Penghasilan Perbulan</td>
		<td width="10">:</td>
		<td width="400"> Rp.<?php echo $data->penghasilan ?> Perbulan</td>
	</tr>
</table>
<br>
<table border="0" align="justify" style="line-height: 25px; font-family: times; font-size: 18px;">
