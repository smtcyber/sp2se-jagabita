<html>
<head>
<title>Cetak Surat Pernyataan Umum</title>
</head>
<body>
...
<?php $this->load->view('nomor_surat/no_pernyataan') ?>
...
<table border="0" align="center" style="line-height: 25px; font-size: 17px;">
	<tr>
	    <td width="30">&nbsp;</td>
		<td width="620" align="justify">Surat ini dibuat untuk keperluan : <?php echo $data->keperluan;?></td>
	    <td width="20">&nbsp;</td>
	</tr>
</table>
<br>
<table border="0" align="center" style="line-height: 25px; font-size: 17px;">
	<tr>
	    <td width="30">&nbsp;</td>
		<td width="620" align="justify" style="text-indent: 3em;">Demikian Surat Keterangan ini kami buat dengan sebenarnya, kepada yang berkepentingan agar menjadi maklum dan harap dipergunakan sebagaimana mestinya.</td>
	    <td width="20">&nbsp;</td>
	</tr>
</table>
<br>
