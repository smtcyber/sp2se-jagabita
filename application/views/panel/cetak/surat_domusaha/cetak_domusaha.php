<html>
<head>
<title>Cetak Surat keterangan Domisili Usaha</title>
</head>
<body>
...
<table border="0" align="center"  style="font-size: 17px;">
	...
	<tr>
		<td width="30">&nbsp;</td>
		<td align="left" width="200">Kedudukan Dalam Usaha</td>
		<td align="left" width="20">:</td>
		<td align="left" width="350"><?php echo $data->jabatan;?></td>
	</tr>
	<tr>
		<td width="30">&nbsp;</td>
...
<table border="0" align="center" style="line-height: 25px; font-size: 17px;">
	<tr>
	    <td width="30">&nbsp;</td>
		<td width="620" align="justify" style="text-indent: 3em;">Adalah benar bahwa Perusahaan "<?php echo $data->jenis_usaha;?>" pada saat ini berdomisili di desa <?php echo ucwords(strtolower($data->kelurahan)) ?> RT <?php echo $data->rt;?> RW <?php echo $data->rw;?> Kecamatan <?php echo ucwords(strtolower($data->kecamatan)) ?> Kabupaten <?php echo ucwords(strtolower($data->kabupaten)) ?>.</td>
	    <td width="20">&nbsp;</td>
	</tr>
</table>
<br>
