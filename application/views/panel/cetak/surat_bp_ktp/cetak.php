            ...
            <div class="col-xs-12">
                <div class="tm-flex">
                    <div class="tm-bg-white-translucent text-xs-left tm-textbox tm-textbox-padding" style="background-color: #5F9EA0; margin-left: 80px;">
                    	<center>
                        <h2 class="tm-text-title" align="center">SURAT KETERANGAN BELUM MEMILIKI KTP</h2>
                        <div style="width: 1000px;">
                            <iframe id="printPage" src="<?php echo base_url()?>index.php/c_bp_ktp/cetak_data_bp_ktp/<?php echo $data->id_bp_ktp ?>" style="height: 400px; width: 750px; border: none; background: white; border: 4px solid white;"></iframe>
							<br><br>
...
<script>
   function printPage()
   {
      ...
      div.innerHTML = '<iframe id="printPage" src="<?php echo base_url()?>index.php/c_bp_ktp/cetak_data_bp_ktp/<?php echo $data->id_bp_ktp ?>" style="height: 400px; width: 700px; border: none; background: white;" onload="this.contentWindow.print();"></iframe>';
   }
</script>
<script>
   function printPage1()
   {
      var div = document.getElementById("printerDiv");
      div.innerHTML = '<iframe id="printPage" src="<?php echo base_url()?>index.php/c_bp_ktp/cetak_data_bp_ktp1/<?php echo $data->id_bp_ktp ?>" style="height: 400px; width: 700px; border: none; background: white;" onload="this.contentWindow.print();"></iframe>';
   }
</script>