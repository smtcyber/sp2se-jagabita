<html>
<head>
<title>Cetak Surat keterangan Belum Memiliki KTP</title>
</head>
<body>
...
<table border="0" align="center" style="line-height: 25px; font-size: 17px;">
	<tr>
	    <td width="30">&nbsp;</td>
		<td width="620" align="justify" style="text-indent: 3em;">Benar nama tersebut diatas adalah penduduk desa kami dan sudah berusia diatas 17 tahun tetapi belum memiliki Kartu Tanda Penduduk ( KTP ) atau Kartu Keluarga ( KK ).</td>
	    <td width="20">&nbsp;</td>
	</tr>
</table>
<br>
...
<table border="0" align="center" style="line-height: 25px font-size: 17px;;">
	<tr>
	    <td width="30">&nbsp;</td>
		<td width="620" align="center">===== <?php echo $data->untuk_persyaratan;?> =====</td>
	    <td width="20">&nbsp;</td>
	</tr>
</table>
<br>
