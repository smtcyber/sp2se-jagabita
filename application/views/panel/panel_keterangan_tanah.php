            ...
            <div class="col-xs-12">
                <div class="tm-flex">
                    <div class="tm-bg-white-translucent text-xs-left tm-textbox tm-textbox-padding" style="background-color: #E6E6FA;">
                        <h2 class="tm-text-title" align="center">SURAT KETERANGAN TANAH</h2>
                            <div class="container">
                                <form action="<?php echo site_url().'/c_keterangan_tanah/proses_panel_keterangan_tanah'?>" method="post">
                                    <div class="row">
                                        <div class="col-69">
                                    ...
                                    <div class="row">
                                        <div class="col-75">
                                            <input class="use-keyboard-input" type="text" id="lname" name="no_objek_pajak" placeholder="Masukkan Nomor Objek Pajak">
                                        </div>
                                    </div>
                                    <br><br>
