                ...
                <div class="tm-flex">
                    <div class="tm-bg-white-translucent text-xs-left tm-textbox tm-textbox-padding" style="background-color: #E6E6FA;">
                        <h2 class="tm-text-title" align="center">SURAT KETERANGAN PERJALANAN</h2>
                            <div class="container">
                                <form action="<?php echo site_url().'/c_keterangan_jalan/proses_panel_keterangan_jalan'?>" method="post">
                                    <div class="row">
                                        <div class="col-69">
                                    ...
                                    <div class="row">
                                        <div class="col-75">
                                            <input class="use-keyboard-input" type="text" id="lname" name="pergi_ke_jalan" placeholder="Masukkan Lokasi Tujuan Perjalanan">
                                        </div>
                                    </div>
                                    <br>
                                    <div class="row">
                                        <div class="col-75">
                                            <input class="use-keyboard-input" type="text" id="lname" name="tujuan_jalan" placeholder="Masukkan Alasan Perjalanan">
                                         </div>
                                    </div>
                                    <br>
                                    <div class="row">
                                        <div class="col-75">
                                            <input class="use-keyboard-input" type="text" id="lname" name="lama_jalan" placeholder="Masukkan Lama Kepergian">
                                         </div>
                                    </div>
                                    <br>
                                    <div class="row">
                                        <div class="col-75">
                                            <input class="use-keyboard-input" type="text" id="lname" name="ket_jalan" placeholder="Masukkan Keterangan">
                                         </div>
                                    </div>
                                    <br><br>
