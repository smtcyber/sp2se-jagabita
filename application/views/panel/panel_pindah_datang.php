            ...
            <div class="col-xs-12">
                <div class="tm-flex">
                    <div class="tm-bg-white-translucent text-xs-left tm-textbox tm-textbox-padding" style="background-color: #E6E6FA;">
                        <h2 class="tm-text-title" align="center">SURAT KETERANGAN PINDAH DATANG</h2>
                            <div class="container">
                                <form action="<?php echo site_url().'/c_pindah_datang/proses_panel_pindah_datang'?>" method="post">
                                    <div class="row">
                                        <div class="col-69">
