            ...
            <div class="col-xs-12">
                <div class="tm-flex">
                    <div class="tm-bg-white-translucent text-xs-left tm-textbox tm-textbox-padding" style="background-color: #E6E6FA;">
                        <h2 class="tm-text-title" align="center">SURAT KETERANGAN KELAHIRAN</h2>
                            <div class="container">
                                <form action="<?php echo site_url().'/c_kelahiran/proses_panel_kelahiran'?>" method="post">
                                    <div class="row">
                                        <div class="col-69">
                                            <input class="use-keyboard-input" type="text" id="fname" name="no_ktp" placeholder="Masukkan NIK Pelapor" required autofocus />
                                        </div>
                                    </div>
                                    <br><br>
