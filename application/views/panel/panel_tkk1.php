            ...
            <div class="col-xs-12">
                <div class="tm-flex">
                    <div class="tm-bg-white-translucent text-xs-left tm-textbox tm-textbox-padding" style="background-color: #E6E6FA;">
                        <h2 class="tm-text-title" align="center">SURAT PENGANTAR KARTU KELUARGA</h2>
                            <div class="container">
                                <form action="<?php echo site_url().'/c_tkk1/proses_panel_tkk1'?>" method="post">
                                    <div class="row">
                                        <div class="col-69">
                                            <input class="jQKeyboard" type="text" id="fname" name="no_ktp" placeholder="Masukkan NIK" required autofocus />
                                        </div>
                                    </div>
                                    <br><br>
                                    <button type="submit" class="btn btn-success" style="width: 220px; height: 60px; font-size: 20px; font-weight: bold; border: 4px solid white;">Proses</button>
