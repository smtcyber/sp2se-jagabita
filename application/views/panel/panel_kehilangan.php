                ...
                <div class="tm-flex">
                    <div class="tm-bg-white-translucent text-xs-left tm-textbox tm-textbox-padding" style="background-color: #E6E6FA;">
                        <h2 class="tm-text-title" align="center">SURAT KETERANGAN KEHILANGAN</h2>
                            <div class="container">
                                <form action="<?php echo site_url().'/c_kehilangan/proses_panel_kehilangan'?>" method="post">
                                    <div class="row">
                                        <div class="col-69">
                                    ...
                                    <div class="row">
                                        <div class="col-75">
                                            <input class="use-keyboard-input" type="text" id="lname" name="kehilangan" placeholder="Masukkan Nama Benda Hilang">
                                        </div>
                                    </div>
                                    <br><br>
