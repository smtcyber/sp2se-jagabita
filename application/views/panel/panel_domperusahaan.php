            ...
            <div class="col-xs-12">
                <div class="tm-flex">
                    <div class="tm-bg-white-translucent text-xs-left tm-textbox tm-textbox-padding" style="background-color: #E6E6FA;">
                        <h2 class="tm-text-title" align="center">SURAT KETERANGAN DOMISILI PERUSAHAAN</h2>
                            <div class="container">
                                <form action="<?php echo site_url().'/c_domperusahaan/proses_panel_domperusahaan'?>" method="post">
                                    <div class="row">
                                        <div class="col-69">
