...
<section class="content-header">
      <h1>
        Data Tabel
        <xsall>Keterangan Yatim</xsall>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-table"></i> Data SP2SE</a></li>
        <li class="active">Keterangan Yatim</li>
      </ol>
</section>
...
<!-- <a href="<?php echo site_url().'/c_yatim/tambah_yatim'?>" class="btn btn-primary btn-rounded">
              ...
              <div class="table-responsive">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <?php } else {
                      $no=1;
                      foreach ($yatim->result() as $tampil) {
                    ?>
                    <tr>
                      ...
                      <td valign="left"><div align="left">
                          <a class="btn btn-warning btn-xs btn-rounded" href="<?php echo base_url()?>index.php/c_yatim/edit_yatim/<?php echo $tampil->id_yatim ?>" title="Edit Beda Identitas"><i class="fa fa-edit"></i> Edit</a>
                          <a class="btn btn-danger btn-xs btn-rounded" href="<?php echo base_url()?>index.php/c_yatim/proses_hapus_yatim/<?php echo $tampil->id_yatim ?>"
                          ...
                          <div class="btn-group">
                            ...
                            <ul class="dropdown-menu" role="menu">
                              <li><a style="color:black;" target="_blank" href="<?php echo base_url()?>index.php/c_yatim/yatim_cetak/<?php echo $tampil->id_yatim ?>"><b>Print Kades</b></a></li>
                              <li><a style="color:black;" target="_blank" href="<?php echo base_url()?>index.php/c_yatim/yatim_cetak1/<?php echo $tampil->id_yatim ?>"><b>Print Atas Nama</b></a></li>
                            </ul>
                          </div>
                      </td>
                    </tr>
