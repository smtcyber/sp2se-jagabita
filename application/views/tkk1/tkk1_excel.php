...
<head>
    ...
    $nama_file = "pengantar_kartu_keluarga.xls";
        ...
        <td align="center">
            ...
            <table align="left" style="font-size: 10px;" border="0">
                <tr>
                    ...
                    <td align="left" colspan="16" style="border: 1px;"><b>&nbsp;<?php echo $tampil->nama;?></b></td>
                    <td align="center" width="15">&nbsp;</td>
                    <td align="left" width="150"><b>&nbsp;&nbsp;Kota Nama Provinsi</b></td>
                    <td align="center" width="15">:</td>
                    <td align="center" width="20" style="border: 1px;">&nbsp;</td>
                    <td align="center" width="20" style="border: 1px;">&nbsp;</td>
                    <td align="center" width="15">&nbsp;</td>
                    <td align="left" width="100" style="border: 1px;"><b>&nbsp;<?php echo ucwords(strtoupper($tampil->propinsi)) ?></b></td>
                </tr>
                <tr>
                    <td align="center" width="80">&nbsp;</td>
                    <td align="left" width="200"><b>Alamat</b></td>
                    <td align="center" width="15">:</td>
                    <td align="left" colspan="16" style="border: 1px;"><b>&nbsp;<?php echo $tampil->dusun;?></b></td>
                    <td align="center" width="15">&nbsp;</td>
                    ...
                    <td align="center" width="20" style="border: 1px;">&nbsp;</td>
                    <td align="center" width="15">&nbsp;</td>
                    <td align="left" width="100" style="border: 1px;"><b>&nbsp;<?php echo ucwords(strtoupper($tampil->kabupaten)) ?></b></td>
                </tr>
                <tr>
                    <td align="center" width="80">&nbsp;</td>
                    ...
                    <td align="center" width="20" style="border: 1px;">&nbsp;</td>
                    <td align="center" width="20" style="border: 1px;">&nbsp;</td>
                    <td align="center" width="25" style="border: 1px;">RT</td>
                    <td align="center" width="20" style="border: 1px;"> <?php echo substr($tampil->rt, 0, 1) ?> </td>
                    <td align="center" width="20" style="border: 1px;"> <?php echo substr($tampil->rt, 1, 1) ?> </td>
                    <td align="center" width="20" style="border: 1px;"> <?php echo substr($tampil->rt, 2, 1) ?> </td>
                    <td align="center" width="25" style="border: 1px;">RW</td>
                    <td align="center" width="20" style="border: 1px;"> <?php echo substr($tampil->rw, 0, 1) ?> </td>
                    <td align="center" width="20" style="border: 1px;"> <?php echo substr($tampil->rw, 1, 1) ?> </td>
                    <td align="center" width="20" style="border: 1px;"> <?php echo substr($tampil->rw, 2, 1) ?> </td>
                    <td align="center" width="120" style="border: 1px;">Jumlah Anggota Keluarga</td>
                    <td align="center" width="20" style="border: 1px;"> <?php echo $tampil->jumlah_keluarga;?> </td>
                    <td align="center" width="30" style="border: 1px;">Orang</td>
                    <td align="center" width="15">&nbsp;</td>
                    ...
                    <td align="center" width="20" style="border: 1px;">&nbsp;</td>
                    <td align="center" width="15">&nbsp;</td>
                    <td align="left" width="100" style="border: 1px;"><b>&nbsp;<?php echo ucwords(strtoupper($tampil->kecamatan)) ?></b></td>
                </tr>
                <tr>
                    <td align="center" width="80">&nbsp;</td>
                    <td align="left" width="200"><b>Telepon</b></td>
                    <td align="center" width="15">:</td>
                    <td align="left" colspan="16" style="border: 1px;"><b>&nbsp; <?php echo $tampil->telepon;?> </b></td>
                    <td align="center" width="15">&nbsp;</td>
                    ...
                    <td align="center" width="20" style="border: 1px;">&nbsp;</td>
                    <td align="center" width="15">&nbsp;</td>
                    <td align="left" width="100" style="border: 1px;"><b>&nbsp;<?php echo ucwords(strtoupper($tampil->kelurahan)) ?></b></td>
                </tr>
                <tr>
                    <td align="center" width="80">&nbsp;</td>
                    ...
                    <td align="center" width="20" style="border: 1px;">&nbsp;</td>
                    <td align="center" width="15">&nbsp;</td>
                    <td align="left" width="100" style="border: 1px;"><b>&nbsp;<?php echo ucwords(strtoupper($tampil->dusun)) ?></b></td>
                </tr>
            </table>
            <table align="left" style="font-size: 9px;" border="0">
                <tr>
            ...
            <table align="left" border="1" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td align="center" width="15" style="font-size: 11px;"><b>1</b></td>
                    <td align="center" colspan="2" style="font-size: 11px;"><b>&nbsp;<?php echo ucwords(strtolower($tampil->h_keluarga)) ?></b></td>
            ...
            <table border="0" style="font-size: 12px;">
                ...
                <tr>
                    ...
                    <td align="center" width="50">&nbsp;</td> 
                    <td align="center" width="200">Pemohon</td>
                </tr>
                <tr>
                    <td align="center" width="100">&nbsp;</td> 
