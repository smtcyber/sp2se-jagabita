...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Edit Pengantar Kartu Keluarga</li>
      </ol>
</section>
...
<form role="form" action="<?php echo site_url().'/c_tkk1/proses_edit_tkk1'?>" method="post" enctype="multipart/form-data" autocomplete="on">
        
<div class="box-header with-border" align="center">
            <button type="submit" class="btn btn-primary"><i class='fa fa-check'></i> Update</button>
            <a class="btn btn-danger" href="<?php echo site_url('c_tkk1/tkk1');?>"><i class='fa fa-times'></i> Batal</a>
        </div>
        </div>
</div>
        <!-- left column -->
        ...
        <?php foreach ($edit_tkk1->result() as $tampil) { ?>
        <div class="box-body">
        <div class="form-group">
            <input type="hidden" class="form-control" name="H1" id="H1" value="<?php echo $tampil->id_tkk1; ?>" />
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label><b>Jumlah Keluarga:</b></label>
            <input class="form-control" name="jumlah_keluarga" id="jumlah_keluarga" value="<?php echo $tampil->jumlah_keluarga; ?>" required>
        </div>
        <div class="form-group">
            <label><b>Hubungan Keluarga :</b></label>
            <select class="form-control" name="hub_keluarga" id="hub_keluarga">
                <option value="<?php echo $tampil->hub_keluarga; ?>"><?php echo $tampil->hub_keluarga; ?></option>
        ...
        <div class="form-group">
            ...
            <input class="form-control" name="telepon" id="telepon" value="<?php echo $tampil->telepon; ?>" required>
        </div>
        <div class="form-group">
 ...
 <div class="col-md-4">
        ...
        <div class="form-group">
            ...
            <select class="form-control" name="jk_pengikut1" id="jk_pengikut1">
                <option value="<?php echo $tampil->tempat_lahir1; ?>"><?php echo $tampil->jk_pengikut1; ?></option>
