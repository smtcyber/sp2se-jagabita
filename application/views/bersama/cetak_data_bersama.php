...
<title>Cetak Surat Pernyataan Bersama</title>
<style type="text/css">
body,td,th {
	font-size: 18px;
	font-family: Times;
...
<table border="0" align="center" style="line-height: 25px;">
	<tr>
		<td width="620" align="justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Apabila  dalam  kesepakatan  tersebut  di  atas  di  kemudian  hari  pihak  pertama  sampai  terjadi hal-hal lain,maka pihak kedua siap dilaporkan ke pihak yang berwajib. Dan mulai saat ini kedua belah pihak atas permintaan kedua orang tuanya tidak boleh saling berhubungan lagi.</td>
	</tr>
</table>
<br>
