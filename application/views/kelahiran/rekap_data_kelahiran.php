...
<title>..::Rekap Data Pernyataan Kelahiran::..</title>
<style type="text/css">
body,td,th {
	font-size: 10px;
}
...
<h4 style="text-align: center;">Rekap Data Pernyataan Kelahiran, Update Tanggal <?php $tanggal_hari_ini= date('Y-m-d'); echo tgl_indo($tanggal_hari_ini); ?></h4><br><br>
...
if ( ! empty($kelahiran)) {
	...
	foreach($kelahiran->result() as $tampil) {
		...
		echo "<td width=200>".$tampil->nama_anak."</td>";
...
<tfoot>
	<tr bgcolor="#4e73df">
		...
		<td><div align="center"><b><?php echo $kelahiran->num_rows();?></b></div></td>
	</tr>
</tfoot>
</table>
</div>
