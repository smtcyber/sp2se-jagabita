...
<table border="0" width="500" align="left" cellpadding="0" cellspacing="0" style="font-size: 12px; font-family: arial;">
	...
	<tr>
		...
		<td align="center" width="280"style="font-size: 12px;"border="0">&nbsp;&nbsp;<?php echo ucwords(strtolower($tampil->kelurahan)) ?>, <?php $tanggal_hari_ini= date('Y-m-d'); echo tgl_indo($tanggal_hari_ini); ?></td>
	</tr>
	<tr>
		<td width="40">&nbsp;</td>
		...
		<td align="center" width="280"style="font-size: 12px;"border="0"><b>PEMOHON</b></td>
	</tr>
		<tr>
		<td width="40">&nbsp;</td>
		...
		<td align="center" width="280"style="font-size: 60px;"border="0">&nbsp;</td>
	</tr>
	<tr>
		<td width="40">&nbsp;</td>
		<td align="center" width="100"style="font-size: 12px;"border="0">&nbsp;</td>
		<td align="center" width="100"style="font-size: 12px;"border="0">&nbsp;</td>
		<td align="center" width="170"style="font-size: 12px;"border="0">&nbsp;</td>
		<td align="center" width="280"style="font-size: 12px;"border="0">&nbsp;&nbsp;<u><b><?php echo $tampil->nama;?></b></u></td>
	</tr>
</table>
...
<table border="0" width="500" align="left" cellpadding="0" cellspacing="0" style="font-size: 12px; font-family: arial;">
	...
	<tr>
		...
		<td align="center" width="200"style="font-size: 12px;"border="0">Mengetahui,</td>
	</tr>
	<tr>
		<td width="40">&nbsp;</td>
		...
		<td align="center" width="200"style="font-size: 12px; text-transform: uppercase;"border="0"><b><?php echo $atas_nama->status; ?> <?php echo ucwords(strtolower($tampil->kelurahan))?></b></td>
	</tr>
	<tr>
		<td width="40">&nbsp;</td>
		...
		<td align="left" width="160"style="font-size: 12px;"border="0">&nbsp;</td>
		<td align="center" width="200"style="font-size: 12px;"border="0"><?php echo $atas_nama->jabatan; ?></td>
	</tr>
	<tr>
		<td width="40">&nbsp;</td>
		...
		<td align="left" width="160"style="font-size: 12px;"border="0">&nbsp;</td>
		<td align="left" width="200"style="font-size: 12px;"border="0">&nbsp;</td>
	</tr>
	<tr>
		<td width="40">&nbsp;</td>
	...
	<tr>
		...
		<td align="center" width="200"style="font-size: 12px;"border="0"><b><u><?php echo $atas_nama->atas_nama; ?></u></b></td>
	</tr>
</table>
</body>
</html>